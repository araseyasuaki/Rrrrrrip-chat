...
import { getFirestore, setDoc, doc, collection, getDoc, getDocs } from "firebase/firestore";
...
export { auth, googleProvider, signInWithPopup, signOut, db, storage, setDoc, doc, collection, getDoc, getDocs, getAuth };
